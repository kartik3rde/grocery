      ...
      isLoading ?
        ...
        activeIndex !== 3 ?
          <View style={styles.container}>
            ...
            {
              activeIndex === 1 && <View style={styles.formField}>
                <TextField
                  label='Mobile Number '
                  ...
                  onChange={(e) => { this._onMobileNoChange(e.nativeEvent.text) }}
                />
            ...
            {
              activeIndex === 2 && <View style={styles.formField}>
                <TextField
                  ...
                  onChange={(e) => { this._onOtpNoChange(e.nativeEvent.text) }}
                />
                <View style={styles.button}>
                  <Button
                    onPress={() => { this._checkOTPLogin() }}
                    title="LOGIN"
                    color={colors.white}
                    backgroundColor={colors.yellow}
                  />
          ...
          <View style={styles.container}>
            ...
            <View style={styles.isRegistredform}>
              <TextField
                ...
                onChange={(e) => { this._onFormChange('numberReg',e.nativeEvent.text,['phoneValidation']) }}
              />
              <TextField
                label='Full Name *'
                ...
                onChange={(e) => { this._onFormChange('nameReg',e.nativeEvent.text,['requiredValidation']) }}
              />
              <TextField
                label='Email *'
                placeholder="Enter Your Mobile Number"
                ...
                onChange={(e) => { this._onFormChange('emailReg',e.nativeEvent.text,['emailValidation']) }}
              />
              <View style={styles.button}>
                <Button
                  onPress={() => {this._onSubmitRegForm()}}
                  title="CONTINUE"
                  color={colors.white}
                  backgroundColor={colors.yellow}
                />
